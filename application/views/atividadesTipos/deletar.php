    ...
    <div class="col-md-8 col-lg-8 col-xs-12">
        <div class="panel panel-default panel-body">
            ...
            <div class="panel-heading bg-gray">
                <h3 class="panel-title"><span class="glyphicon glyphicon-pencil"></span>&nbsp;&nbsp;&nbsp; Deseja realmente excluir este tipo de atividade?</h3>
            </div>
            <?php
            echo form_open("atividadesTipos/deletar/$atividadesTiposId", array('class' => 'form-horizontal col-lg-12'));
            ?>
            <div class="body">
                <fieldset>
                    <div class="form-group">
                        ...
                        <?php echo form_input(array('name' => 'atividadesTiposNome', 'class' => 'form-control'), set_value('atividadesTiposNome', $query->atividadesTiposNome), 'disabled'); ?>
                    </div>
                    </div>
                    <div class="form-group">
